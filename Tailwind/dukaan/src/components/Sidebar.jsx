    ...
    return (
        <>
            <div className="w-1/6  bg-[#1E2640] text-white p-2 min-h-screen">
                ...
                <div className='flex justify-self-auto items-center p-4 mt-2'>
                    <ul>

                        <li className='flex p-2 gap-3'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
